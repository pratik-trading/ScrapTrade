...
export default function PurchaseForm() {
  ...
  const handleChange = (e) => {
    ...
    // Auto-calculate taxable amount from weight * rate
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Card className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Input label="Bill Number *" name="billNumber" value={form.billNumber} onChange={handleChange} placeholder="PUR-001" required />
        ...
        <Card className="p-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full text-sm text-gray-600 dark:text-gray-400 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-medium file:bg-orange-50 file:text-orange-700 dark:file:bg-orange-500/10 dark:file:text-orange-400"
            />
          </div>
        </Card>

        {/* Final amount preview */}
        <div className="flex items-center justify-between bg-orange-50 dark:bg-orange-500/10 border border-orange-200 dark:border-orange-500/20 rounded-xl px-5 py-4">
